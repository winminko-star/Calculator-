...
const pretty = (v) => {
  ...
  // သင်ထည့်သလိုပဲပြချင်လို့ fixed decimals မသုံး — FP noise သေချာဖယ်
  ...
  return (
    <div className="container grid" style={{ gap: 16 }}>
      <div className="card">
        ...
        <div className="small">ဘယ်ဘက်သို့/ညာဘက်သို့ ဆွဲပြီး result အားလုံးကြည့်နိုင်ပါတယ်။</div>
      </div>

      {items.map((it) => {
        // cols သိပ်မလိုတော့ဘူး — flex scroll နဲ့ auto wrap off
        ...
        return (
          <div key={it.id} className="card" style={{ display: "block" }}>
            ...
            {/* RESULTS: scrollable horizontally, no wrap */}
            <div style={{ overflowX: "auto", paddingBottom: 4, marginTop: 10 }}>
              <div
                style={{
                  ...
                  flexWrap: "nowrap",
                  gap: 10,
                  // iOS momentum scroll နည်းနည်းကူညီ
              ...
              >
                {(it.results || []).map((r, idx) => (
                  <div
                    ...
                    className="card"
                    style={{
                      flex: "0 0 96px",    // ✅ အချင်းချင်းတိုက်မတိုးဘဲ အလျားတန်းစီ
                      padding: 8,
                      textAlign: "center",
